...
public class ChessBoard {
	...
	public ChessPiece move(String codeStart, String codeEnd) throws IllegalMoveException {
		if (!isValidBoardPosition(codeStart))
			throw new IllegalMoveException("Starting position [" + codeStart + "] is not valid.");
		if (!isValidBoardPosition(codeEnd))
			throw new IllegalMoveException("Ending position [" + codeEnd + "] is not valid.");
